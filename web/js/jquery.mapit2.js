...
document.write('<scr'+'ipt type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAFgS2ZkOBN2Gcol-1nRwEbhomGpjcmgtU" ></scr'+'ipt>');
	...
	$.fn.mapit = function(options) {
		...
		var defaults = {
			...
			marker: {
				latitude: 	48.8917356,
				longitude: 2.4668547999999646,
				icon: 			'images/icons/logoThaiMarker.png',
				title: 			'Repair Shop',
				open: 			false,
				center: 		true
			},
